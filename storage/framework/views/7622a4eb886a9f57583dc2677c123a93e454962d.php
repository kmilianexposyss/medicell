...
<div class="breadcrumb">
    <h1><?php echo e(__('translate.Project_List')); ?></h1>
    <ul>
        <li><?php echo e(__('translate.Project')); ?></li>
        <li><?php echo e(__('translate.Project_List')); ?></li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-header text-right bg-transparent">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project_add')): ?>
                <a class="btn btn-primary btn-md m-1" href="<?php echo e(route('projects.create')); ?>"><i
                ...
                <div class="table-responsive">
                    <table id="project_list_table" class="display table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td @click="selected_row( <?php echo e($project->id); ?>)"></td>
                                ...
                                <td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project_details')): ?>
                                    <a href="/projects/<?php echo e($project->id); ?>" class="ul-link-action text-info"
                                    ...
                                    <a href="/projects/<?php echo e($project->id); ?>/edit" class="ul-link-action text-success"
                                        data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="i-Edit"></i>
                                    </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project_delete')): ?>
                                    <a @click="Remove_Project( <?php echo e($project->id); ?>)"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/exposyss.com/medicell.exposyss.com/resources/views/project/project_list.blade.php ENDPATH**/ ?>