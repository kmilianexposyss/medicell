...
<div class="breadcrumb">
    <h1><?php echo e(__('translate.Create_Employee')); ?></h1>
    <ul>
        <li><a href="/employees"><?php echo e(__('translate.Employees')); ?></a></li>
        <li><?php echo e(__('translate.Create_Employee')); ?></li>
    </ul>
</div>
                    ...
                    <div class="form-row ">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="FirstName"
                                placeholder="<?php echo e(__('translate.Enter_FirstName')); ?>" v-model="employee.firstname">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="LastName"
                                placeholder="<?php echo e(__('translate.Enter_LastName')); ?>" v-model="employee.lastname">
                        ...
                        <div class="col-md-6">
                            <label class="ul-form__label"><?php echo e(__('translate.Gender')); ?> <span
                                    class="field_required">*</span></label>
                            <v-select @input="Selected_Gender" placeholder="<?php echo e(__('translate.Choose_Gender')); ?>"
                        ...
                        <div class="col-md-6 form-group">
                            <label class="ul-form__label" for="picker3"><?php echo e(__('translate.Birth_date')); ?></label>

                            <vuejs-datepicker id="birth_date" name="birth_date"
                                placeholder="<?php echo e(__('translate.Enter_Birth_date')); ?>" v-model="employee.birth_date"
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputEmail4" class="ul-form__label"><?php echo e(__('translate.Email_Address')); ?> <span
                                    class="field_required">*</span></label>
                            <input type="email" class="form-control" id="inputtext4"
                                placeholder="<?php echo e(__('translate.Enter_email_address')); ?>" v-model="employee.email">
                        ...
                        <div class="form-group col-md-6">
                            <label for="country" class="ul-form__label"><?php echo e(__('translate.Country')); ?> <span
                                    class="field_required">*</span></label>
                            <input type="text" class="form-control" id="country"
                                placeholder="<?php echo e(__('translate.Enter_Country')); ?>" v-model="employee.country">
                        ...
                        <div class="form-group col-md-6">
                            <label for="phone" class="ul-form__label"><?php echo e(__('translate.Phone_Number')); ?> <span
                                    class="field_required">*</span></label>
                            <input type="text" class="form-control" id="phone"
                                placeholder="<?php echo e(__('translate.Enter_Phone_Number')); ?>" v-model="employee.phone">
                        ...
                        <div class="col-md-6 form-group">
                            <label class="ul-form__label" for="picker3"><?php echo e(__('translate.Joining_Date')); ?></label>

                            <vuejs-datepicker id="joining_date" name="joining_date"
                                placeholder="<?php echo e(__('translate.Enter_Joining_Date')); ?>" v-model="employee.joining_date"
                                input-class="form-control" format="yyyy-MM-dd"
                        ...
                        <div class="form-group col-md-6">
                            <label class="ul-form__label"><?php echo e(__('translate.Department')); ?> <span
                                    class="field_required">*</span></label>
                            <v-select @input="Selected_Department" placeholder="<?php echo e(__('translate.Choose_Department')); ?>"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <v-select @input="Selected_Designation"
                                placeholder="<?php echo e(__('translate.Choose_Designation')); ?>" v-model="employee.designation_id"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/exposyss.com/medicell.exposyss.com/resources/views/employee/create_employee.blade.php ENDPATH**/ ?>