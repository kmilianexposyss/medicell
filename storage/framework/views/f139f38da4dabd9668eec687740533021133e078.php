...
<div class="breadcrumb">
    <h1><?php echo e(__('translate.Edit_Task')); ?></h1>
    <ul>
        <li><a href="/tasks"><?php echo e(__('translate.Tasks')); ?></a></li>
        <li><?php echo e(__('translate.Edit_Task')); ?></li>
    </ul>
</div>
...
<script>
    ...
    data: {
        ...
        employees:<?php echo json_encode($employees, 15, 512) ?>,
        task: <?php echo json_encode($task, 15, 512) ?>,
        assigned_employees:<?php echo json_encode($assigned_employees, 15, 512) ?>,
        tooltip:'right',
    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/exposyss.com/medicell.exposyss.com/resources/views/task/edit_task.blade.php ENDPATH**/ ?>