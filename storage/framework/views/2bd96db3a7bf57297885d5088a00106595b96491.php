...
<div class="breadcrumb">
    ...
    <ul>
        <li><a href="/settings/system_settings"><?php echo e(__('translate.System_Settings')); ?></a></li>
...
<section id="section_System_Settings_list">
                ...
                <div class="card-body">
                    <form @submit.prevent="Update_Settings()" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="ul-form__label"><?php echo e(__('translate.Default_Currency')); ?> <span
                                        class="field_required">*</span></label>
                                <v-select @input="Selected_Currency"
                                    placeholder="<?php echo e(__('translate.Enter_Default_Currency')); ?>"
                            ...
                            <div class="col-md-4">
                                <label for="email" class="ul-form__label"><?php echo e(__('translate.Default_Email')); ?> <span
                                        class="field_required">*</span></label>
                                <input type="text" v-model="setting.email" class="form-control" id="email" id="email"
                                    placeholder="<?php echo e(__('translate.Enter_Default_Email')); ?>">
                            ...
                            <div class="col-md-4">
                                <label for="logo" class="ul-form__label"><?php echo e(__('translate.Change_Logo')); ?> </label>
                            ...
                            <div class="col-md-4">
                                <label for="Phone" class="ul-form__label"><?php echo e(__('translate.Company_Phone')); ?> <span
                                        class="field_required">*</span></label>
                                <input type="text" v-model="setting.CompanyPhone" class="form-control" id="Phone"
                                    placeholder="<?php echo e(__('translate.Enter_Company_Phone')); ?>">
                            ...
                            <div class="col-md-4">
                                <label for="developed_by" class="ul-form__label"><?php echo e(__('translate.Developed_by')); ?>

                                    <span class="field_required">*</span></label>
                                <input type="text" v-model="setting.developed_by" class="form-control" id="developed_by"
                                    placeholder="<?php echo e(__('translate.Enter_Developed_by')); ?>">
                            ...
                            <div class="col-md-4">
                                <label for="footer" class="ul-form__label"><?php echo e(__('translate.Footer')); ?> <span
                                        class="field_required">*</span></label>
                                <input type="text" v-model="setting.footer" class="form-control" id="footer"
                                    placeholder="<?php echo e(__('translate.Enter_Footer')); ?>">
                            ...
                            <div class="col-md-4">
                                <label class="ul-form__label"><?php echo e(__('translate.Time_Zone')); ?> <span
                                    class="field_required">*</span></label>
                                <v-select @input="Selected_Time_Zone"
                                    placeholder="<?php echo e(__('translate.Time_Zone')); ?>"
                            ...
                            <div class="col-md-12">
                                <label for="CompanyAdress" class="ul-form__label"><?php echo e(__('translate.Company_Adress')); ?>

                                    <span class="field_required">*</span></label>
                                <textarea type="text" v-model="setting.CompanyAdress" class="form-control"
                                    name="CompanyAdress" id="CompanyAdress"
                                    placeholder="<?php echo e(__('translate.Enter_Company_Adress')); ?>"></textarea>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <span><?php echo e(__('translate.Email_Settings')); ?></span>
                </div>
                <!--begin::form-->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" v-model="email_settings.encryption" class="form-control"
                                    id="encryption" id="encryption" placeholder="<?php echo e(__('translate.Mail_Encryption')); ?>">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <span><?php echo e(__('translate.Clear_Cache')); ?></span>
                </div>
                <!--begin::form-->
                <div class="card-body">
                    <form @submit.prevent="Clear_Cache()">
                        <div class="row">
                            ...
                            <button type="submit" class="btn btn-primary" :disabled="Submit_Processing_Clear_Cache">
                                <?php echo e(__('translate.Clear_Cache')); ?>
...
<script>
    Vue.component('v-select', VueSelect.VueSelect)
        ...
        data: {
            ...
            setting: <?php echo json_encode($setting, 15, 512) ?>,
            email_settings: <?php echo json_encode($email_settings, 15, 512) ?>,
            currencies: <?php echo json_encode($currencies, 15, 512) ?>,
            zones_array:<?php echo json_encode($zones_array, 15, 512) ?>,
        },
            ...
            Clear_Cache() {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        toastr.success('<?php echo e(__('translate.Cache_cleared_successfully')); ?>');
                    })
                    .catch(error => {
                        self.Submit_Processing_Clear_Cache = false;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/exposyss.com/medicell.exposyss.com/resources/views/settings/system_settings/system_settings_list.blade.php ENDPATH**/ ?>